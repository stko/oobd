...
function Start(oldvalue,id)
	...
	addElement("Cluster DTC XML", "dtcStatusXML","-",0x0, "500b11_720")
	addElement("Cluster DTC Status", "dtcStatus","-",0x0, "500b11_720")
	addElement("PDM DTC XML", "dtcStatusXML","-",0x0, "125b11_741")
	addElement("DTC Status", "dtcStatus","-",0x0, "125b11_741")
	pageDone()
	return oldvalue
end
