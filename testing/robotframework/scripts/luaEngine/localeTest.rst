...
.. code:: robotframework
    ...
    *** Test Cases ***
    ...
    Test localize message - default locale set
        send webUI command  {"name":"testlocale:","optid":"2","actValue":"","updType":3}
	answer should match    {"type":"VALUE" ,"value":"#Good Morning"}
    Test localize message - german locale set
        send webUI command  {"name":"testlocale:","optid":"3","actValue":"","updType":3}
	answer should match    {"type":"VALUE" ,"value":"#Moin,Moin"}
    Test localize message - klingonian locale set
        send webUI command  {"name":"testlocale:","optid":"4","actValue":"","updType":3}
	answer should match    {"type":"VALUE" ,"value":"#Good Morning"}
