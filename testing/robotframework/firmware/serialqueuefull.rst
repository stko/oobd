...
.. code:: robotframework
    ...
    *** Test Cases ***
    ...
    send killer sequence
	: FOR    ${INDEX}    IN RANGE    1    15
	\    Log    ${INDEX}
	\	send dongle command  p 8 3 3
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 8 4 0
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 8 2 3
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 6 5 $737
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 8 14
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 8 10 1 $0737
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  p 8 11 1 $07F0
	\	answer should match    .*(\\.\\+cr\\+>)
	\	send dongle command  190202
	\	answer should match    .*(\\+cr\\+>)
	\	send dongle command  19028D
	\	answer should match    .*(\\+cr\\+>)
