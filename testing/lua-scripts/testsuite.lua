...
TestData_0_F103 = { t = "Ascii Data", sev_r = "22", ses_r ="01;03;", sd = {
...
id0x14 = { byte = 1 , size =  1 , mult = 0.0055 , offset = 0, unit = "Volts"} ,
...
id0x3E = { byte = 1 , size = 2 , mult = 0.1 , offset = -40, unit = "°C"} ,
