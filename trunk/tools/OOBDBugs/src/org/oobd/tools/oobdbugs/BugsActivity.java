...
import org.oobd.tools.oobdbugs.R;
import org.oobd.tools.oobdbugs.GoogleCodeXmlParser.Entry;
...
//        myWebView.loadData(getResources().getString(R.string.connection_error), "text/html", "utf-8");
    ...
    private String loadXmlFromNetwork(String urlString) throws XmlPullParserException, IOException {
        ...
        GoogleCodeXmlParser GoogleCodeXmlParser = new GoogleCodeXmlParser();
        ...
        try {
            ...
            entries = GoogleCodeXmlParser.parse(stream);
        ...
        // GoogleCodeXmlParser returns a List (called "entries") of Entry objects.
