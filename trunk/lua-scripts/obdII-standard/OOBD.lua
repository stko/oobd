...
id0x3C = { byte = 2 , size = 1 , mult = 0.1 , offset = -40, unit = "°C"} ,
id0x3D = { byte = 2 , size = 1 , mult = 0.1 , offset = -40, unit = "°C"} ,
id0x3E = { byte = 2 , size = 1 , mult = 0.1 , offset = -40, unit = "°C"} ,
id0x3F = { byte = 2 , size = 1 , mult = 0.1 , offset = -40, unit = "°C"} ,
