...
void IAP_Init(void) {
	...
	/* configure PA8/PB1 as Input for Hardwareidentifikaton */
	/* PA8 = 1, PB1 = 0 - Original DXM1
	 * PA8 = 1, PB1 = 1 - OOBD-Cup v5
	 * PA8 = 0, PB1 = 1 - OOBD-Cup ??? reserved for further development
	 * PA8 = 0, PB1 = 0 - OOBD-Cup ??? reserved for further development
	 */
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
	...
	if ((GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_8) == Bit_SET)
			&& (GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_1) == Bit_SET))
