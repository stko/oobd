...
{'cmd':'p 8 3 1\r','res':r'.*(.).*','next':17,'err':-1,'descr':'set CAN 125kb / 11b','okText':'OK: Bus set','errText':'Error: No correct Answer'},
{'cmd':'p 8 4 1\r','res':r'.*(.).*','next':18,'err':-1,'descr':'set Channel 0','okText':'OK: Channel set','errText':'Error: No correct Answer'},
{'cmd':'p 8 2 3\r','res':r'.*(.).*','next':19,'err':-1,'descr':'set Bus active','okText':'OK: Bus activated','errText':'Error: No correct Answer'},
{'cmd':'p 6 5 $741\r','res':r'.*(.).*','next':20,'err':-1,'descr':'set Module ID','okText':'OK: Module ID set','errText':'Error: No correct Answer'},
...
{'cmd':'p 6 9 $749\r','res':r'.*(.).*','next':23,'err':-1,'descr':'set Send ID','okText':'OK: Send ID set','errText':'Error: No correct Answer'},
{'cmd':'1002\r','res':r'^(50).*','next':-1,'err':24,'descr':'send Tester present','okText':'OK: Answer from Module','errText':'Error: No correct Answer'},
{'cmd':'1002\r','res':r'^(50).*','next':-1,'err':25,'descr':'send Tester present','okText':'OK: Answer from Module','errText':'Error: No correct Answer'},
