...
<xsl:template match="UNSIGNED"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , mult = <xsl:value-of select="./Resolution"/> , offset = <xsl:value-of select="./Offset"/> , unit = "<xsl:value-of select="./Units"/>" , dtype = "UNSIGNED" , title = "<xsl:value-of select="./Name"/>"} ,
</xsl:template>

<xsl:template match="SIGNED"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , mult = <xsl:value-of select="./Resolution"/> , offset = <xsl:value-of select="./Offset"/> , unit = "<xsl:value-of select="./Units"/>" , dtype = "SIGNED", title = "<xsl:value-of select="./Name"/>"} ,
</xsl:template>

<xsl:template match="FLOAT"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , mult = <xsl:value-of select="./Resolution"/> , offset = <xsl:value-of select="./Offset"/> , unit = "<xsl:value-of select="./Units"/>" , dtype = "FLOAT", title = "<xsl:value-of select="./Name"/>"} ,
</xsl:template>

<xsl:template match="BCD"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , mult = <xsl:value-of select="./Resolution"/> , offset = <xsl:value-of select="./Offset"/> , unit = "<xsl:value-of select="./Units"/>" , dtype = "BCD", title = "<xsl:value-of select="./Name"/>"} ,
</xsl:template>

<xsl:template match="ASCII"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , dtype = "ASCII", title = "<xsl:value-of select="./Name"/>" },
</xsl:template>

<xsl:template match="BYTE"> <xsl:param name="paramPCK" /><xsl:if test="$paramPCK = 1">id0x<xsl:value-of select="./Bit" /><xsl:value-of select="./BitPos" /> = </xsl:if> {  pos = <xsl:value-of select="./BytePos"/> , len = <xsl:value-of select="./ByteNr"/> , mult = <xsl:value-of select="./Resolution"/> , offset = <xsl:value-of select="./Offset"/> , unit = "<xsl:value-of select="./Units"/>" , dtype = "BYTE", title = "<xsl:value-of select="./Name"/>"} ,
</xsl:template>
