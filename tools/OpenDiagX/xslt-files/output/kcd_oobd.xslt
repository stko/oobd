...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:b="http://kayak.2codeornot2code.org/1.0">

<xsl:template match="/">
  <xsl:apply-templates/>

a
     <xsl:for-each select="b:NetworkDefinition">
